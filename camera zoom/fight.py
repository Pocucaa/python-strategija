...
# Create instances of CameraGroup and Player
    ...
    camera_group = CameraGroup(left_inactive_zone, top_inactive_zone)


# ------------------------------------------------------------------------------------------------------------------------------------  start 

    # Draw the scene with custom camera settings
    ...
    while play:                                                          
        ...
        camera_group.custom_draw(tile_size, mumija_idle, vitez_idle, left_inactive_zone, top_inactive_zone)
